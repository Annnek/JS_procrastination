...
//   random phrase as a result button click
button.addEventListener('click', function () {
  let randomElement = getRandomElement(phrases);
  smoothly(phrase, 'textContent', randomElement.text); //smoothly - library html-animation
  smoothly(image, 'src', randomElement.image); //To replace the image address, you need to rewrite the property src

  // change font size because of phrase's length 
